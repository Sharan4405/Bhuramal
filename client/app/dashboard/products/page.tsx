  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      if (data.success) {
        ...
        // Filter/search ke baad hamesha page 1 par aao
        setCurrentPage(1);
      }
    } catch (error) {
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <button
                ...
                className="bg-linear-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-3 rounded-lg font-semibold flex items-center gap-2 shadow-md hover:shadow-lg transition-all"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
                ...
                {currentProducts.map((product) => (
                  <Card key={product._id} className="p-4">
                    ...
                    <div className="flex items-center justify-between mb-3 text-sm">
                      ...
                      <span className="text-xl font-bold text-[rgb(var(--orange))]">
                        ₹{product.price}
                      </span>
                    </div>
